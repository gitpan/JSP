...
JSP::Function - Reference to a javascript Function
...
The basic way to invoke a JSP::Function instance is with the
method L<JSP::Context/call>.
...
Instances of JSP::Function implement a short cut to avoid such verbose
code:
...
This class inherits from JSP::Object.
...
when the JSP::Function is seen as a L<JSP::Object>
...
And inherit the overload C<%{}> from L<JSP::Object/"OVERLOADED OPERATORS">.
