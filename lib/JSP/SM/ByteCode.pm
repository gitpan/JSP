package JSP::SM::ByteCode;
use strict;
use warnings;

use JSP::SM::Opcode qw(:jof @Opcodes);
...
JSP::SM::Bytecode - A class for inspect SpiderMonkey's bytecode
...
Returns an instance with the bytecode of the prologue of the C<JSP::Script>
instance I<$script>.

=item main( I<$script> );

Returns an instance with the main bytecode of the C<JSP::Script>
instance I<$script>.
