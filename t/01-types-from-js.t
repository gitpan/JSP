...
# Get global object
isa_ok($cx1->get_global, "JSP::Object", "Global Object");
...
# Booleans
{
    ...
    isa_ok($t1, "JSP::Boolean", "Wrapped true");
    pass("Boolean true works") if $t1;

    my $f1 = $cx1->eval("1 == 0;");
    ok(!$f1 , "False");
    isa_ok($f1, "JSP::Boolean", "Wrapped false");
...
# Anonymous objects
{
    ...
    isa_ok(tied(%$obj), 'JSP::Object', "Boxed");
...

{
    ...
    isa_ok(tied(%{$hash}), 'JSP::Object', "Tied JS object");
    my $clone = $hash;
    isa_ok($clone, 'HASH', "Correct type");
    isa_ok(tied(%{$clone}), 'JSP::Object', "Cloned tied");
    ...
    isa_ok(tied(%{$hash->{b}}), 'JSP::Object', "JS Object again");
...
# Arrays
{
    ...
    my $jsobj = tied(@{$arr});
    isa_ok($jsobj, 'JSP::Array', "Is a JS Array");
    isa_ok($jsobj, 'JSP::Object', "Object too");
    my $len = $jsobj->length;
    is($len, 0, 'Is empty');
...
# Complex objects
{
    ...
    isa_ok(tied(%{$obj}), 'JSP::Object', 'Is object');
    my $a = $obj->{a};
