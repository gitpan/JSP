...
isa_ok($func, "JSP::Function");
isa_ok($func, "JSP::Object", "Also");
is($cx1->call($func, 4, 3), 12, 'Call via JSP::Function object via $context->call');

is($func->(4, 5), 20, "Call via JSP::Function object direct invocation");
...

{
    ...
    isa_ok($proto, 'JSP::Object', "The proto");
    { 
	local $cx1->{AutoTie} = 0;
